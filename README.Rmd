...
**Note:** ichimoku object specification released 2021-08-08 - *please install build 0.3.51 or above to ensure compatibility.*
...
- [`archive()`](https://shikokuchuo.net/ichimoku/reference/archive.html) - for reading and writing ichimoku objects to/from Apache Arrow archives.
