...
- [`rplot()`](https://shikokuchuo.net/ichimoku/reference/rplot.html) - to plot a customisable reactive cloud chart from an ichimoku object.

#### Strategies & ML

- [`strat()`](https://shikokuchuo.net/ichimoku/reference/strat.html) - to augment an ichimoku object with a strategy.

- [`stratcombine()`](https://shikokuchuo.net/ichimoku/reference/stratcombine.html) - to combine and create more complex strategies.
