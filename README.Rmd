...
```
**Note:** ichimoku object specification (v1) released 2021-08-08 - please install build 0.3.51 or above to ensure compatibility.
...
- [`ichimoku_write()`](https://shikokuchuo.net/ichimoku/reference/ichimoku_write.html) and [`ichimoku_read()`](https://shikokuchuo.net/ichimoku/reference/ichimoku_read.html) - for archival of ichimoku objects in the Apache Arrow IPC file format.
