...
Source:
[`inst/CITATION`](https://github.com/shikokuchuo/ichimoku/blob/main/inst/CITATION)

Gao C (2025). *ichimoku: Visualization and Tools for Ichimoku Kinko Hyo
Strategies*. R package version 1.5.7.9000,
<https://doi.org/10.5281/zenodo.7879346>.
    ...
    @Manual{,
      ...
      author = {Charlie Gao},
      year = {2025},
      note = {R package version 1.5.7.9000},
