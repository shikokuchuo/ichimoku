...
[`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md). The
...
inspected in case it contains unwanted duplicates. Use
...
[`df_merge()`](https://shikokuchuo.net/ichimoku/reference/df_merge.md),
...
[`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md), this
is retained. If the attribute is not found in ‘new’, the argument has no
effect. All other custom attributes are dropped.
