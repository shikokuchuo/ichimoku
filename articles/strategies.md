...
vignette](https://shikokuchuo.net/ichimoku/articles/reference.md).
...
The use of
[`strat()`](https://shikokuchuo.net/ichimoku/reference/strat.md) returns
an augmented ichimoku object. The printout above of a slice of the
object (rows 100 to 105) shows that the following columns are appended:
...
[`strat()`](https://shikokuchuo.net/ichimoku/reference/strat.md) simply
by supplying ‘c3’ and ‘c4’ to the function. These are the quoted column
...
[`stratcombine()`](https://shikokuchuo.net/ichimoku/reference/stratcombine.md)
...
[`mlgrid()`](https://shikokuchuo.net/ichimoku/reference/mlgrid.md) is
used to power the
[`autostrat()`](https://shikokuchuo.net/ichimoku/reference/autostrat.md)
and
