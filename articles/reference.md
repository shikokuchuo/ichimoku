...
vignette](https://shikokuchuo.net/ichimoku/articles/xoanda.md).
...
[`more()`](https://shikokuchuo.net/ichimoku/reference/more.md) to
...
vignette](https://shikokuchuo.net/ichimoku/articles/strategies.md) for
...
[`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md):
...
- `strat` \[default TRUE\] if true, the periods for which a strategy
  ...
  vignette](https://shikokuchuo.net/ichimoku/articles/strategies.md) for
  more information on working with strategies.
...
[`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md) takes
the following additional parameters for customisation:
...
write operations will take 2 arguments: the object to be written, and
the file path/name of the file to be stored. If the second argument is
left empty, a system dialog will be opened allowing the file save
...
[`archive()`](https://shikokuchuo.net/ichimoku/reference/archive.md) for
read operations takes a single argument: the file path/name of the file
to be read. Alternatively, if no arguments are specified, a system
