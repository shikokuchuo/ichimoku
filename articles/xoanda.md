...
e.g. [`oanda_stream()`](https://shikokuchuo.net/ichimoku/reference/oanda_stream.md)
or
...
[`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md) above
...
This button uses
[`archive()`](https://shikokuchuo.net/ichimoku/reference/archive.md) to
save the ichimoku object to disk. The filename will be of the form:
...
[`look()`](https://shikokuchuo.net/ichimoku/reference/look.md). A chart
showing the percentage long and short orders/positions at each price
level is output to the graphical device.
