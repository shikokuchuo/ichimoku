...
test_that("internal window functions ok", {
  expect_identical(.Call(`_ichimoku_minOver`, as.numeric(1:6), 3L), c(NA, NA, 1, 2, 3, 4))
  expect_identical(.Call(`_ichimoku_maxOver`, as.numeric(1:6), 3L), c(NA, NA, 3, 4, 5, 6))
  expect_identical(.Call(`_ichimoku_meanOver`, as.numeric(1:6), 3L), c(NA, NA, 2, 3, 4, 5))
})
