...
Can be used to inspect the informational attributes of objects created by the ichimoku package. This includes ichimoku objects or objects returned by `autostrat()`, `mlgrid()` or `oanda()`.
