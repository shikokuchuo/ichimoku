...
The following S3 methods for the generic 'zoo' functions are provided:
...
As the extracted objects are simple base types, they can be easily modified as required.
