...
### Function modifications since version 0.2
...
### Function modifications since version 0.1
...
- httr - for interfacing with external APIs
- jsonlite - for processing data retrieved from external APIs
...
- keyring - for storing external API credentials
