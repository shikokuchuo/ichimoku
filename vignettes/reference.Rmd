...
As an ichimoku object inherits the ‘xts’ and ‘zoo’ classes, all the existing methods for these classes should work seamlessly. For working with ichimoku objects, please see the section [re-exports](#re-exports).
