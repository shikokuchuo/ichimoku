...
```{r viewdata}
# Some synthetic pricing data is loaded as a dataframe 'TKR':
head(TKR)
```
...
The returned object is consistently-formatted, with the following 11 columns:
...
A section (rows 100 to 110) of the cloud object is shown above. Note that print is called setting 'plot = FALSE' to return the dataframe without the plot.
