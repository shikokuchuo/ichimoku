...
#### Writing
`archive()` for write operations will take 2 arguments: the ichimoku object to be written, and the file path/name of the object to be stored. A confirmation is printed to the console once the file has been written.
