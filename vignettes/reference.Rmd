...
This allows you to consolidate all relevant data into a single object. There is also the added benefit that it can now be plotted as a sub-plot beneath the main ichimoku cloud chart (see [custom sub-plots](#custom-sub-plots)).
...
Gao, C. (2021), *ichimoku: Visualization and Tools for Ichimoku Kinko Hyo Strategies*. R package version 1.1.7, <https://CRAN.R-project.org/package=ichimoku>.
