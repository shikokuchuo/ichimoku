...
[`look`](https://shikokuchuo.net/ichimoku/reference/look.md) on the
returned list.
...
[`vignette("strategies", package = "ichimoku")`](https://shikokuchuo.net/ichimoku/articles/strategies.md)
