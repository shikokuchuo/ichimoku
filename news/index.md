...
- [`format_POSIXct()`](https://shikokuchuo.net/ichimoku/reference/format_POSIXct.md)
...
- [`oanda_studio()`](https://shikokuchuo.net/ichimoku/reference/oanda_studio.md)
...
- [`archive()`](https://shikokuchuo.net/ichimoku/reference/archive.md)
...
- [`oanda_quote()`](https://shikokuchuo.net/ichimoku/reference/oanda_quote.md)
...
- Fixes
  [`oanda_switch()`](https://shikokuchuo.net/ichimoku/reference/oanda_switch.md)
...
- [`mlgrid()`](https://shikokuchuo.net/ichimoku/reference/mlgrid.md)
...
- [`oanda_instruments()`](https://shikokuchuo.net/ichimoku/reference/oanda_instruments.md)
...
- Improved performance and reliability of
  [`oanda_stream()`](https://shikokuchuo.net/ichimoku/reference/oanda_stream.md).
  Returned dataframe no longer contains the column ‘type’, which was
  always ‘PRICE’.
- Fixes to
  [`ichimoku()`](https://shikokuchuo.net/ichimoku/reference/ichimoku.md)
...
- In conjunction with the new print method,
  [`more()`](https://shikokuchuo.net/ichimoku/reference/more.md) now
...
- Fixed regression in 1.3.2 which caused
  [`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md) to
  fail.
...
- The `theme` argument of
  ...
  [`oanda_chart()`](https://shikokuchuo.net/ichimoku/reference/oanda_chart.md)
...
- Sub-plots now feature on the same chart and values can be read via the
  infotip in
  [`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md) or
  [`oanda_studio()`](https://shikokuchuo.net/ichimoku/reference/oanda_studio.md).
- R/S-type indicators now an option for
  [`oanda_chart()`](https://shikokuchuo.net/ichimoku/reference/oanda_chart.md)
  and
  [`oanda_studio()`](https://shikokuchuo.net/ichimoku/reference/oanda_studio.md).
- [`.ichimoku()`](https://shikokuchuo.net/ichimoku/reference/dot-ichimoku.md)
...
- Further performance enhancements to
  [`ichimoku()`](https://shikokuchuo.net/ichimoku/reference/ichimoku.md),
  [`mlgrid()`](https://shikokuchuo.net/ichimoku/reference/mlgrid.md) and
  plot functions.
...
- Enhancement to the printing of ichimoku objects by utilising the
  ...
  with [`more()`](https://shikokuchuo.net/ichimoku/reference/more.md)
  for quick printing of further rows.
- Optimised `as_tibble()` method implemented for ichimoku objects.
- [`mlgrid()`](https://shikokuchuo.net/ichimoku/reference/mlgrid.md) now
  appends attributes ‘k’ and ‘type’ to returned objects, and gains the
  following arguments:
...
- New
  [`oanda_orders()`](https://shikokuchuo.net/ichimoku/reference/oanda_orders.md)
...
- [`oanda_positions()`](https://shikokuchuo.net/ichimoku/reference/oanda_positions.md)
...
- [`archive()`](https://shikokuchuo.net/ichimoku/reference/archive.md)
  ...
  e.g. `archive(object, )`.
- [`index()`](https://shikokuchuo.net/ichimoku/reference/index.ichimoku.md)
...
- Simplification of
  [`look()`](https://shikokuchuo.net/ichimoku/reference/look.md) by
...
- Minor enhancements to the [`str()`](https://rdrr.io/r/utils/str.html)
  method.
- [`df_append()`](https://shikokuchuo.net/ichimoku/reference/df_append.md)
...
- [`oanda_view()`](https://shikokuchuo.net/ichimoku/reference/oanda_view.md)
  updated for new instruments and now returns correct data types in the
  dataframe.
- Fixes cases of
  [`relative()`](https://shikokuchuo.net/ichimoku/reference/relative.md)
...
- [`autostrat()`](https://shikokuchuo.net/ichimoku/reference/autostrat.md),
  [`relative()`](https://shikokuchuo.net/ichimoku/reference/relative.md)
  and [`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md)
...
- Optimised ‘ichimoku’ methods for
  [`coredata()`](https://shikokuchuo.net/ichimoku/reference/coredata.ichimoku.md)
  and
  [`index()`](https://shikokuchuo.net/ichimoku/reference/index.ichimoku.md)
  generic functions.
- ‘ichimoku’ method for
  ...
  [`xts_df()`](https://shikokuchuo.net/ichimoku/reference/xts_df.md) for
  ichimoku objects.
...
- Improved appearance of progress indicators for
  [`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md) and
  [`oanda_view()`](https://shikokuchuo.net/ichimoku/reference/oanda_view.md).
- [`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md) now
  safe to use non-interactively - it will no longer prompt in such
  cases.
- Improvements to the visual appearance of oscillator plots.
- Update to the interactive interface for
  [`oanda_set_key()`](https://shikokuchuo.net/ichimoku/reference/oanda_set_key.md).
...
- For ease of use, the ‘instrument’ argument in all OANDA functions is
  ...
  acceptable.
- [`tradingDays()`](https://shikokuchuo.net/ichimoku/reference/tradingDays.md)
...
- Fix issue which caused
  [`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md) to
  re-calculate the indicators when adjusting the data window.
...
- [`plot.ichimoku()`](https://shikokuchuo.net/ichimoku/reference/plot.ichimoku.md)
...
- Fixes data types issue affecting dataframes returned by
  [`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md) in
  v1.0.0.
...
- New
  ...
  package.
- [`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md) gains
  the capability to download over 5000 data periods in multiple
  (rate-limited) requests when both the ‘from’ and ‘to’ arguments are
  specified.
- [`look()`](https://shikokuchuo.net/ichimoku/reference/look.md) can now
  inspect any R object.
- [`ichimoku()`](https://shikokuchuo.net/ichimoku/reference/ichimoku.md)
...
- [`tradingDays()`](https://shikokuchuo.net/ichimoku/reference/tradingDays.md)
  ...
  no non-trading days.
- [`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md) and
  [`oanda_studio()`](https://shikokuchuo.net/ichimoku/reference/oanda_studio.md)
...
- [`xts_df()`](https://shikokuchuo.net/ichimoku/reference/xts_df.md) and
  [`matrix_df()`](https://shikokuchuo.net/ichimoku/reference/matrix_df.md)
...
- [`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md)
...
- [`oanda_chart()`](https://shikokuchuo.net/ichimoku/reference/oanda_chart.md)
  ...
  [`autoplot()`](https://shikokuchuo.net/ichimoku/reference/autoplot.ichimoku.md).
- [`ichimoku()`](https://shikokuchuo.net/ichimoku/reference/ichimoku.md)
...
- Fixes issue which caused
  [`oanda()`](https://shikokuchuo.net/ichimoku/reference/oanda.md) not
  to return weekly data in certain cases.
- Corrects trade success statistics for short strategies returned by
  [`strat()`](https://shikokuchuo.net/ichimoku/reference/strat.md).
- The following functions are no longer exported to keep the package
  tidy:
  [`grid_dup()`](https://shikokuchuo.net/ichimoku/reference/grid_dup.md),
...
- [`oanda_studio()`](https://shikokuchuo.net/ichimoku/reference/oanda_studio.md)
  ...
  app.
- [`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md) is
  re-launched using R Shiny. Introduces an intuitive cursor infotip that
  allows data to be read directly from the chart.
- [`look()`](https://shikokuchuo.net/ichimoku/reference/look.md)
  ...
  by
  [`autostrat()`](https://shikokuchuo.net/ichimoku/reference/autostrat.md).
- [`strat()`](https://shikokuchuo.net/ichimoku/reference/strat.md) and
  [`autostrat()`](https://shikokuchuo.net/ichimoku/reference/autostrat.md)
...
- [`strat()`](https://shikokuchuo.net/ichimoku/reference/strat.md) now
  takes optional ‘c3’ and ‘c4’ arguments to provide parameters for
  complex strategies. This allows a combined strategy to be specified
  using a single
  [`strat()`](https://shikokuchuo.net/ichimoku/reference/strat.md) call.
- [`iplot()`](https://shikokuchuo.net/ichimoku/reference/iplot.md) now
  uses a Shiny backend. Plotly charts have been retired.
